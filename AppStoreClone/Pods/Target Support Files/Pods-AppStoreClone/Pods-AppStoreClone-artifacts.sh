...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/Reveal-SDK/RevealServer/RevealServer.xcframework" "" "true" "ios-arm64_x86_64-maccatalyst/RevealServer.framework" "ios-arm64_armv7/RevealServer.framework" "ios-arm64_i386_x86_64-simulator/RevealServer.framework"
fi
